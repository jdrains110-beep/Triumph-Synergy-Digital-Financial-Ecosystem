...
console.log('Updated package.json — added devDependencies and updated test script.');

// Install the added dev dependencies
try {
  console.log('Running pnpm add -D baseline-browser-mapping@latest cross-env@latest ...');
  cp.execSync('pnpm add -D baseline-browser-mapping@latest cross-env@latest', { stdio: 'inherit' });
...
console.log('Done. You can now run `pnpm test` using PowerShell (it will use cross-env).');
