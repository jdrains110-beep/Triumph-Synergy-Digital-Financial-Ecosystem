...
# attach a custom domain: history.triumphsynergy.com
```
...
[HISTORY.local]
get="curl -sf https://history.triumphsynergy.com/{0} -o {1}"
...
curl -s https://history.triumphsynergy.com/.well-known/stellar-history.json | python3 -m json.tool
```

## Custom domain — `history.triumphsynergy.com`
