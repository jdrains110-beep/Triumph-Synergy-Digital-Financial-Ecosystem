    ...
    <div className="w-full max-w-4xl mx-auto p-6 space-y-6">
      ...
      <Alert className="border-blue-500 bg-blue-50">
        ...
        <AlertDescription className="text-blue-900">
          <strong>Legal Notice:</strong> By signing this contract, you are entering into a legally
          binding agreement. Your signature will be recorded with timestamp, device information, and
          location for legal compliance (ESIGN Act, UETA).
        </AlertDescription>
      </Alert>
      ...
      {success && (
        <Alert className="border-green-500 bg-green-50">
          ...
          <AlertDescription className="text-green-900">
            Contract signed successfully! A certificate has been generated and will be downloaded.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="border rounded-lg p-6 space-y-4">
        <div className="flex items-start space-x-3">
          <Checkbox
            ...
            className="mt-1"
          />
          <label htmlFor="accept" className="flex-1 text-sm font-medium leading-relaxed">
            <span className="block">
              I have read and understand this contract and agree to be legally bound by all terms
              and conditions.
            </span>
            <span className="block text-xs text-gray-600 mt-2">
              By checking this box, you are providing active electronic consent as required by law
              and acknowledge that your signature will be recorded with:
            </span>
        ...
        <Dialog open={showSignaturePad} onOpenChange={setShowSignaturePad}>
          <DialogContent>
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={() => setShowSignaturePad(false)}>Confirm Signature</Button>
            </div>
          </DialogContent>
        </Dialog>
      )}
      ...
      {/* Compliance Info */}
      <div className="text-xs text-gray-600 bg-gray-50 p-4 rounded border border-gray-200">
