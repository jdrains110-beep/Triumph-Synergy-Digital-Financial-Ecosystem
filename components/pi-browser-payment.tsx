        ...
        Pi.createPayment(
          ...
          },
          {
            onReadyForServerApproval: async (currentPaymentId: string) => {
              console.log("[Pi Payment] Ready for approval:", currentPaymentId);
              ...
              try {
                ...
                console.log("[Pi Payment] Approved by server:", currentPaymentId);
              } catch (approveErr) {
                setError(
            ...
            onReadyForServerCompletion: async (
              ...
              try {
                ...
                console.log(
                  "[Pi Payment] Completed by server:",
                  currentPaymentId
                );
                setPhase("success");
                onSuccess?.(currentPaymentId, currentTxid);
                resolve(null);
              } catch (completeErr) {
                setError(
            ...
            onError: (errorMessage: string, _payment: any) => {
              console.error("[Pi Payment] Payment error:", errorMessage);
  ...
  return (
    <div className="flex flex-col gap-4 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg">
      ...
      <button
        ...
        disabled={phase !== "idle"}
        className={`w-full px-4 py-3 rounded font-medium text-white transition ${
          phase === "idle"
