...
# License: PiOS
"""
Triumph Synergy Ecosystem Guardian — Health Governor module
────────────────────────────────────────────────────────────
Part of triumph-ecosystem-guardian (consolidated watchdog pod).
Monitors ALL 33+ Triumph containers via the Docker API socket
...
Features:
 ...
 - Covers all 33+ services including sovereign delivery, PiDEX, sports hub
"""
...
# ── Full Triumph Synergy mesh: all 33+ services ──────────────────────────
SERVICE_HEALTH_MAP = {
    # ── Core infrastructure ──────────────────────────────────────────────
    ...
    "triumph-sovereign-gateway":        "http://triumph-sovereign-gateway:8097/health",
    "triumph-qpu-bridge":               "http://triumph-qpu-bridge:8098/health",
    "triumph-sovereign-ai-bot":         "http://triumph-sovereign-ai-bot:8099/health",
    "triumph-sovereign-delivery-engine":"http://triumph-sovereign-delivery-engine:8100/health",
    "triumph-sovereign-pidex-engine":   "http://triumph-sovereign-pidex-engine:8101/health",
    "triumph-sovereign-sports-hub":     "http://triumph-sovereign-sports-hub:8102/health",
}
