...
export async function GET(request: NextRequest) {
  try {
    ...
    const baseMetadata = {
      ...
      description: 'Advanced payment routing platform powered by Pi Network with Stellar blockchain settlement, biometric authentication, and enterprise-grade compliance.',
      keywords: ['Pi Network', 'Pi Payments', 'Payment Processing', 'Cryptocurrency', 'Fintech', 'Blockchain', 'Stellar'],
    ...
    if (pathname === '/' || pathname === '') {
      pageMetadata = {
        ...
        description: 'Experience the future of payments with Pi Network integration, Stellar blockchain settlement, and enterprise-grade security. Accept Pi payments globally.',
        category: 'finance',
      ...
      pageMetadata = {
        ...
        description: 'Explore our comprehensive ecosystem of payment applications built on Pi Network. From e-commerce to gaming, all integrated with secure Pi payments.',
        category: 'business',
      ...
      pageMetadata = {
        ...
        description: 'View and manage your Pi Network payment transactions with complete transparency and security.',
        category: 'finance',
      ...
      pageMetadata = {
        ...
        description: 'Get instant support and guidance with our advanced AI assistant powered by Pi Network technology.',
        category: 'technology',
    ...
    const twitter = {
      ...
      title: pageMetadata.title || baseMetadata.title,
      description: pageMetadata.description || baseMetadata.description,
      images: ['https://triumph-synergy-jeremiah-drains-projects.vercel.app/og-image.png'],
      site: '@triumphsynergy'
    };
