...
const PiPaymentButton = dynamic(
	() => import("../../components/PiPaymentButton"),
	{
		ssr: false,
			...
			<div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					<PiPaymentButton
						...
						onSuccess={(tx) => console.log("Test payment success:", tx)}
						onError={(err) => console.error("Test payment error:", err)}
						metadata={{
					...
					<PiPaymentButton
						...
						onSuccess={(tx) => console.log("Standard payment success:", tx)}
						onError={(err) => console.error("Standard payment error:", err)}
						metadata={{
