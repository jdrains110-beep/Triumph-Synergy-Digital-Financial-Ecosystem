...
export const eCommerceApp: RegisteredApplication = {
  ...
  apiEndpoint: "https://triumphsynergy.com/api/ecommerce",
  paymentConfig: {
    appId: "ecommerce-app",
    callbackUrl: "https://triumphsynergy.com/api/ecommerce/pi-callback",
    sandbox: IS_SANDBOX,
  },
...
export const marketplaceApp: RegisteredApplication = {
  ...
  version: "1.0.0",
  author: "Triumph Synergy",
  apiEndpoint: "https://triumphsynergy.com/api/marketplace",
  paymentConfig: {
    appId: "marketplace-app",
    callbackUrl: "https://triumphsynergy.com/api/marketplace/pi-callback",
    sandbox: IS_SANDBOX,
  },
...
export const gamingApp: RegisteredApplication = {
  ...
  version: "1.0.0",
  author: "Triumph Synergy",
  apiEndpoint: "https://triumphsynergy.com/api/gaming",
  paymentConfig: {
    appId: "gaming-app",
    callbackUrl: "https://triumphsynergy.com/api/gaming/pi-callback",
    sandbox: IS_SANDBOX,
  },
