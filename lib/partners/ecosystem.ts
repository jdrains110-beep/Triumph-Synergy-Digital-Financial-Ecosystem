...
export const partnerEcosystemConfig = {
  ...
  types: {
    ...
    merchant: {
      ...
      benefits: {
        ...
        silver: { commission: 0.04, support: 'email-phone', analytics: 'advanced' },
        gold: { commission: 0.03, support: 'priority', analytics: 'advanced', marketing: true },
        platinum: { commission: 0.02, support: 'dedicated', analytics: 'premium', marketing: true, consulting: true },
        diamond: { commission: 0.01, support: 'white-glove', analytics: 'enterprise', marketing: true, consulting: true, customization: true }
      }
    },
    ...
    financial: {
      ...
      categories: ['payment-gateway', 'bnpl', 'merchant-cash-advance', 'insurance'],
  ...
  api: {
    ...
    dx: {
      ...
      sdks: {
        languages: ['javascript', 'typescript', 'python', 'ruby', 'php', 'java', 'go', 'csharp'],
  ...
  marketplaceIntegrations: {
    ...
    platforms: [
      {
        name: 'amazon',
        capabilities: ['import-products', 'sync-inventory', 'fulfill-orders', 'sync-reviews']
      },
      {
        name: 'ebay',
