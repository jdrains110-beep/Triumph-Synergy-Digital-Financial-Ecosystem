...
export interface GrocerantLocation {
  id: string;
  name: string;
  code: string;
  type: LocationType;
...
export interface GrocerantAddress {
  street: string;
  unit: string | null;
  city: string;
  state: string;
...
export interface GrocerantOrder {
  id: string;
  userId: string;
  locationId: string;
...
class PhygitalGrocerantPlatform {
  private locations: Map<string, GrocerantLocation> = new Map();
  private products: Map<string, Product> = new Map();
  private orders: Map<string, GrocerantOrder> = new Map();
  private customers: Map<string, Customer> = new Map();
  private recipes: Map<string, Recipe> = new Map();
  private smartCarts: Map<string, SmartCart> = new Map();
    ...
    const locations: GrocerantLocation[] = [
      {
        ...
        operatingHours: {
          monday: { isOpen: true, openTime: "6:00 AM", closeTime: "11:00 PM", breakStart: null, breakEnd: null },
          tuesday: { isOpen: true, openTime: "6:00 AM", closeTime: "11:00 PM", breakStart: null, breakEnd: null },
          wednesday: { isOpen: true, openTime: "6:00 AM", closeTime: "11:00 PM", breakStart: null, breakEnd: null },
          thursday: { isOpen: true, openTime: "6:00 AM", closeTime: "11:00 PM", breakStart: null, breakEnd: null },
          friday: { isOpen: true, openTime: "6:00 AM", closeTime: "12:00 AM", breakStart: null, breakEnd: null },
          saturday: { isOpen: true, openTime: "7:00 AM", closeTime: "12:00 AM", breakStart: null, breakEnd: null },
          sunday: { isOpen: true, openTime: "7:00 AM", closeTime: "10:00 PM", breakStart: null, breakEnd: null },
          holidays: [],
        },
        status: "open",
        capabilities: {
        ...
        departments: [
          { id: "dept-1", name: "Fresh Produce", code: "PROD", type: "produce", products: [], manager: null, isActive: true },
          { id: "dept-2", name: "Artisan Bakery", code: "BAKE", type: "bakery", products: [], manager: null, isActive: true },
          { id: "dept-3", name: "Gourmet Deli", code: "DELI", type: "deli", products: [], manager: null, isActive: true },
          { id: "dept-4", name: "Prime Butcher", code: "MEAT", type: "meat", products: [], manager: null, isActive: true },
          { id: "dept-5", name: "Fresh Seafood", code: "SEA", type: "seafood", products: [], manager: null, isActive: true },
          { id: "dept-6", name: "Chef's Kitchen", code: "CHEF", type: "prepared-foods", products: [], manager: null, isActive: true },
          { id: "dept-7", name: "Pi Café & Bar", code: "CAFE", type: "cafe", products: [], manager: null, isActive: true },
        ],
        managerId: "manager-1",
        staffCount: 150,
        metrics: {
          dailyTransactions: 3500,
          averageBasketSize: 78.50,
      ...
      },
      {
        ...
        operatingHours: {
          monday: { isOpen: true, openTime: "6:00 AM", closeTime: "9:00 PM", breakStart: null, breakEnd: null },
          tuesday: { isOpen: true, openTime: "6:00 AM", closeTime: "9:00 PM", breakStart: null, breakEnd: null },
          wednesday: { isOpen: true, openTime: "6:00 AM", closeTime: "9:00 PM", breakStart: null, breakEnd: null },
          thursday: { isOpen: true, openTime: "6:00 AM", closeTime: "9:00 PM", breakStart: null, breakEnd: null },
          friday: { isOpen: true, openTime: "6:00 AM", closeTime: "10:00 PM", breakStart: null, breakEnd: null },
          saturday: { isOpen: true, openTime: "7:00 AM", closeTime: "10:00 PM", breakStart: null, breakEnd: null },
          sunday: { isOpen: true, openTime: "8:00 AM", closeTime: "8:00 PM", breakStart: null, breakEnd: null },
          holidays: [],
        },
        status: "open",
        capabilities: {
        ...
        departments: [
          { id: "dept-e1", name: "Grab & Go", code: "GNG", type: "prepared-foods", products: [], manager: null, isActive: true },
          { id: "dept-e2", name: "Fresh Express", code: "FREX", type: "produce", products: [], manager: null, isActive: true },
          { id: "dept-e3", name: "Coffee Bar", code: "CAFE", type: "cafe", products: [], manager: null, isActive: true },
        ],
        managerId: "manager-2",
        staffCount: 25,
        metrics: {
          dailyTransactions: 1200,
          averageBasketSize: 22.50,
    ...
    const products: Product[] = [
      {
        ...
        description: "Premium organic Hass avocados, perfectly ripe and ready to eat",
        category: "Produce",
        subcategory: "Organic",
        price: 2.99,
      ...
      },
      {
        ...
        description: "Fresh ahi tuna, avocado, edamame, cucumber, and sesame over sushi rice",
        ...
        isMenuItem: true,
        prepTime: 8,
        ingredients: ["ahi tuna", "sushi rice", "avocado", "edamame", "cucumber", "sesame seeds", "ponzu"],
      ...
      },
      {
        ...
        description: "Our house-roasted espresso with steamed milk and optional flavors",
        category: "Beverages",
        subcategory: "Coffee",
        price: 5.50,
    ...
    const recipes: Recipe[] = [
      {
        ...
        description: "Elevated avocado toast with perfectly poached eggs and everything bagel seasoning",
        cuisine: "American",
        prepTime: 10,
        cookTime: 5,
        servings: 2,
        difficulty: "easy",
        ingredients: [
          { name: "Sourdough bread", quantity: 2, unit: "slices", productId: null, isOptional: false },
          { name: "Organic Hass Avocados", quantity: 1, unit: "whole", productId: "prod-1", isOptional: false },
          { name: "Eggs", quantity: 2, unit: "large", productId: null, isOptional: false },
          { name: "Everything bagel seasoning", quantity: 1, unit: "tbsp", productId: null, isOptional: false },
          { name: "Red pepper flakes", quantity: 0.5, unit: "tsp", productId: null, isOptional: true },
        ],
        instructions: [
  ...
  async searchLocations(filters: {
    ...
    return Array.from(this.locations.values()).filter((loc) => {
      if (filters.city && !loc.address.city.toLowerCase().includes(filters.city.toLowerCase())) return false;
      if (filters.type && loc.type !== filters.type) return false;
      if (filters.capability && !loc.capabilities[filters.capability]) return false;
      if (filters.acceptsPi !== undefined && loc.acceptsPi !== filters.acceptsPi) return false;
      return true;
    });
  }
  ...
  async searchProducts(filters: {
    ...
    return Array.from(this.products.values()).filter((prod) => {
      ...
      if (filters.isOrganic !== undefined && prod.isOrganic !== filters.isOrganic) return false;
      if (filters.isVegan !== undefined && prod.isVegan !== filters.isVegan) return false;
      if (filters.isGlutenFree !== undefined && prod.isGlutenFree !== filters.isGlutenFree) return false;
      if (filters.isMenuItem !== undefined && prod.isMenuItem !== filters.isMenuItem) return false;
      if (filters.maxPrice !== undefined && prod.price > filters.maxPrice) return false;
      return true;
    });
  }
  ...
  async createOrder(orderData: {
    ...
    orderType: OrderType;
    channel: OrderChannel;
    items: { productId: string; quantity: number; modifications?: ItemModification[]; specialInstructions?: string }[];
  ...
  async updateOrderStatus(orderId: string, status: OrderStatus): Promise<GrocerantOrder> {
  ...
  async updateLoyaltyPoints(customerId: string, points: number, isPi: boolean = false): Promise<Customer> {
  ...
  async searchRecipes(filters: {
    ...
    return Array.from(this.recipes.values()).filter((r) => {
      ...
      if (filters.isVegan !== undefined && r.isVegan !== filters.isVegan) return false;
      if (filters.isGlutenFree !== undefined && r.isGlutenFree !== filters.isGlutenFree) return false;
      if (filters.maxPrepTime !== undefined && r.prepTime > filters.maxPrepTime) return false;
      return true;
    });
  }
  ...
  async startSmartCartSession(locationId: string, customerId: string): Promise<SmartCart> {
  ...
  async scanItemToCart(cartId: string, productId: string): Promise<SmartCart> {
    ...
    cart.recommendations = await this.getSmartRecommendations(cart.items.map((i) => i.productId));

    return cart;
  }

  private async getSmartRecommendations(productIds: string[]): Promise<Product[]> {
...
export async function searchGrocerantProducts(filters: Parameters<typeof phygitalGrocerantPlatform.searchProducts>[0]): Promise<Product[]> {
  return phygitalGrocerantPlatform.searchProducts(filters);
}

export async function createGrocerantOrder(data: Parameters<typeof phygitalGrocerantPlatform.createOrder>[0]): Promise<GrocerantOrder> {
