...
import { PhysicalHubConfig } from './physical-hub-framework';
...
export const PublixHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 100000, // 100k Pi/day
  monthlyTransactionVolume: 2000000, // 2M Pi/month average
  ...
  tokenBackingPool: 5000000, // 5M Pi for token backing
  infrastructureAllocation: 1000000, // 1M Pi for infrastructure
  ecosystemAllocation: 500000, // 500k Pi for ecosystem growth
...
export const DHGateHubConfig: PhysicalHubConfig = {
  ...
  operatingCountries: ['China', 'USA', 'UK', 'Germany', 'France', 'Canada', 'Australia'],
  ...
  dailyTransactionCapacity: 500000, // 500k Pi/day
  monthlyTransactionVolume: 10000000, // 10M Pi/month average
  acceptedProductCategories: [
    'electronics',
    'smartphones',
    'computers',
  ...
  tokenBackingPool: 25000000, // 25M Pi for token backing
  infrastructureAllocation: 5000000, // 5M Pi for infrastructure
  ecosystemAllocation: 2000000, // 2M Pi for ecosystem
...
export const NikeHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 250000, // 250k Pi/day
  monthlyTransactionVolume: 5000000, // 5M Pi/month average
  acceptedProductCategories: [
    'athletic_footwear',
    'apparel',
    'sportswear',
  ...
  tokenBackingPool: 15000000, // 15M Pi for token backing
  infrastructureAllocation: 3000000, // 3M Pi for infrastructure
  ecosystemAllocation: 1500000, // 1.5M Pi for ecosystem
...
export const CaterpillarHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 1000000, // 1M Pi/day
  monthlyTransactionVolume: 20000000, // 20M Pi/month average
  acceptedProductCategories: [
    'heavy_equipment',
    'machinery',
    'parts',
  ...
  tokenBackingPool: 50000000, // 50M Pi for token backing
  infrastructureAllocation: 10000000, // 10M Pi for infrastructure
  ecosystemAllocation: 5000000, // 5M Pi for ecosystem
...
export const AmazonHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 2000000, // 2M Pi/day
  monthlyTransactionVolume: 40000000, // 40M Pi/month average
  acceptedProductCategories: [
    'everything',
    'electronics',
    'books',
  ...
  tokenBackingPool: 100000000, // 100M Pi for token backing
  infrastructureAllocation: 20000000, // 20M Pi for infrastructure
  ecosystemAllocation: 10000000, // 10M Pi for ecosystem
...
export const AppleHubConfig: PhysicalHubConfig = {
  ...
  tokenBackingPool: 30000000, // 30M Pi for token backing
  infrastructureAllocation: 6000000, // 6M Pi for infrastructure
  ecosystemAllocation: 3000000, // 3M Pi for ecosystem
...
export const GraceKennedyHubConfig: PhysicalHubConfig = {
  ...
  operatingCountries: ['Jamaica', 'Cayman Islands', 'Belize', 'Caribbean region'],
  ...
  dailyTransactionCapacity: 150000, // 150k Pi/day
  monthlyTransactionVolume: 3000000, // 3M Pi/month average
  acceptedProductCategories: [
    'financial_services',
    'insurance',
    'money_transfer',
  ...
  tokenBackingPool: 8000000, // 8M Pi for token backing
  infrastructureAllocation: 1500000, // 1.5M Pi for infrastructure
  ecosystemAllocation: 1000000, // 1M Pi for ecosystem
...
export const SeprodHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 200000, // 200k Pi/day
  monthlyTransactionVolume: 4000000, // 4M Pi/month average
  acceptedProductCategories: [
    'distribution',
    'consumer_goods',
    'food_and_beverage',
  ...
  tokenBackingPool: 10000000, // 10M Pi for token backing
  infrastructureAllocation: 2000000, // 2M Pi for infrastructure
  ecosystemAllocation: 1000000, // 1M Pi for ecosystem
...
export const JamrockMartHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 80000, // 80k Pi/day
  monthlyTransactionVolume: 1600000, // 1.6M Pi/month average
  acceptedProductCategories: ['apparel', 'accessories', 'footwear', 'casual_wear'],
  
  tokenBackingPool: 4000000, // 4M Pi for token backing
  infrastructureAllocation: 800000, // 800k Pi for infrastructure
  ecosystemAllocation: 400000, // 400k Pi for ecosystem
...
export const AppleAndEveHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 120000, // 120k Pi/day
  monthlyTransactionVolume: 2400000, // 2.4M Pi/month average
  acceptedProductCategories: ['beverages', 'juices', 'drinks', 'grocery'],
  
  tokenBackingPool: 6000000, // 6M Pi for token backing
  infrastructureAllocation: 1200000, // 1.2M Pi for infrastructure
  ecosystemAllocation: 600000, // 600k Pi for ecosystem
...
export const RuloncoHubConfig: PhysicalHubConfig = {
  ...
  dailyTransactionCapacity: 300000, // 300k Pi/day
  monthlyTransactionVolume: 6000000, // 6M Pi/month average
  acceptedProductCategories: [
    'distribution',
    'logistics',
    'consumer_goods',
...
export const HUB_METADATA = {
  totalHubs: 11,
  totalLocations: 6035,
  totalDailyCapacity: 5280000, // 5.28M Pi/day
  totalMonthlyCapacity: 102000000, // 102M Pi/month
  totalTokenBackingPool: 288000000, // 288M Pi
  totalInfrastructureAllocation: 56200000, // 56.2M Pi
  totalEcosystemAllocation: 28700000, // 28.7M Pi
  geographicReach: [
    'North America',
    'South America',
    'Europe',
